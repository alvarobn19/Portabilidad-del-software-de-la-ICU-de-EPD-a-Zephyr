...
struct tc_handler {
	...
	ccsds_pus_tc_df_header_t tc_df_header;
        ...
        //!flag to avoid emitting duplicated execution start verification
        bool_t   verif_start_emitted;

        //!flag to avoid emitting duplicated execution completion verification
        bool_t   verif_completed_emitted;
