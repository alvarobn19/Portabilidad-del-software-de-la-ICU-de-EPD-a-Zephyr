...
public:
    ...
    * \param pQueueHeads pointer to component queue heads.
        */
        ...
        CEDROOMQueue(const CEDROOMQueue&) = delete;
        CEDROOMQueue& operator=(const CEDROOMQueue&) = delete;
        CEDROOMQueue(CEDROOMQueue&&) = delete;
        CEDROOMQueue& operator=(CEDROOMQueue&&) = delete;
...
public:
  ...
  CEDROOMComponent(const CEDROOMComponent&) = delete;
  CEDROOMComponent& operator=(const CEDROOMComponent&) = delete;
  CEDROOMComponent(CEDROOMComponent&&) = delete;
  CEDROOMComponent& operator=(CEDROOMComponent&&) = delete;
